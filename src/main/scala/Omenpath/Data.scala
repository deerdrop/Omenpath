...
object Data:
  ...
  val slotKeyFrames = LazyList(30, 15, 18, 21, 25, 29, 34, 40).padTo(30, 48).scanLeft(0)(_ + _).drop(1)
  val slotTimeUntilStop: Int = 20             // Number of ticks for a slot to stop spinning from full speed.
