...
object Data:
  val newSeason: Int = 9                      // Number of the Season being rolled.
  ...
  val slotTimeUntilStop: Int = 30             // Number of ticks for a slot to stop spinning from full speed. NOT SYNCED. Equivalent to the 3s stop animation in style.css
  ...
  lazy val SeasonRecord = Map(
    ...
    "Season 8" -> Vector("AER", "BRO", "GTC", "SOM", "M10", "AFR", "ISD", "SHM", "BFZ", "M19")
  )